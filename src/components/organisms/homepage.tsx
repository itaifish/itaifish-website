export function HomePage() {
	return <><div className="w-full z-50 top-0 py-3 sm:py-5  absolute">
	...
	<li className="group pl-6">
			...
			<span className="cursor-pointer pt-0.5 font-header font-semibold uppercase text-white">Statistics</span><span
				className="block h-0.5 w-full bg-transparent group-hover:bg-yellow"
			></span>
        </li>
